...
public  class ParametrosSistema {
    ...
    public static String URL="jdbc:mysql://localhost:3306/cregescon?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    public static String CONECTION_USER="root";
    public static String CONECTION_PASS="root";
    //MODULOS DEL SISTEMA
